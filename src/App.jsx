...
const projects = [
  ...
  { number: "04", title: "UPI Fraud Detection", type: "Machine learning web application", description: "A Flask application that uses a Random Forest classifier to predict whether a UPI transaction is fraudulent from its time, amount, and UPI number, with model comparison and evaluation workflows.", tech: ["Python", "Flask", "Random Forest", "Scikit-learn"], link: "https://github.com/Upendra23397/upi_fraud_detection" }
];
